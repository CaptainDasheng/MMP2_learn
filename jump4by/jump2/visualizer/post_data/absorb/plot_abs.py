...
ax1.arrow(1.03,200, 0.0, -90, fc='r', ec='r',
	head_width=0.05, head_length=10)
ax1.text(1.03-0.8, 220, "$\mathregular{E_{g}="+str(1.03)+"}$",fontsize=8)
ax2.arrow(0.81,200, 0.0, -90, fc='r', ec='r',
	head_width=0.05, head_length=10)
ax2.text(0.81-0.6, 220, "$\mathregular{E_{g}="+str(0.81)+"}$",fontsize=8)
showf = False
showl = False
bdf   = 'optics'

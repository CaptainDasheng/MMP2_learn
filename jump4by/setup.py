...
# authors %
authors='Lijun Zhang, Xin-Gang Zhao, Yuhao Fu, Jian Lv, \
         Guangren Na, Shulin Luo, Bangyu Xing, Dongwen Yang, \
         Yuanhui Sun, Dianlong Zhao, Xin He, Tianshu Li, \
         Qiaoling Xu, Xijiang Wang,Yawen Li'
